...
// https://github.com/vllm-project/vllm/blob/main/csrc/quantization/cutlass_w8a8/scaled_mm_c2x_sm80_dispatch.cuh
...
template <template <typename, typename> typename Epilogue,
          typename... EpilogueArgs>
void cutlass_scaled_mm_sm80_int8_epilogue(torch::Tensor& out, torch::Tensor const& a,
                                     torch::Tensor const& b,
...
void int8_scaled_mm_sm80(torch::Tensor& out, torch::Tensor const& a,
  ...
  return cutlass_scaled_mm_sm80_int8_epilogue<c2x::ScaledEpilogueBiasAzpToken>(
