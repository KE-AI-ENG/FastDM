'''
This script is used to merge the lora weights into the diffusion transformer model weights. 
It will save a new transformer model with the lora weights merged into it.

# usage: python merge_lora.py --model-path <diffusion_model_path> --lora-path <lora_model_path> --merged-model-path <output_model_path>
'''
